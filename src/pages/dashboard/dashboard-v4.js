      ...
      <div>
        <ol className="breadcrumb float-xl-right">
          <li className="breadcrumb-item">
            <Link to="/dashboard/v4">Home</Link>
          </li>
          <li className="breadcrumb-item">
            <Link to="/dashboard/v4">Dashboard</Link>
          </li>
          <li className="breadcrumb-item active">Dashboard v2</li>
        </ol>
        <h1 className="page-header">
          Dashboard v4 is hereee<small>header small text goes here...</small>
        </h1>
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-xl-4">
            <Panel>
              <PanelHeader noButton={true}>Visitors Origin</PanelHeader>
          ...
          <div className="col-xl-4 col-lg-6">
            <Panel className="bg-light">
              <PanelHeader noButton={true}>
                Chat History{" "}
                <span className="label bg-teal pull-right pt-0 pb-0">
                  4 message
                </span>
              </PanelHeader>
              <PerfectScrollbar
              ...
              >
                <div className="left">
                  ...
                  <Link to="/dashboard/v4" className="name">
                    Sowse Bawdy
                  </Link>
                  <Link to="/dashboard/v4" className="image">
                ...
                <div className="right">
                  ...
                  <Link to="/dashboard/v4" className="name">
                    <span className="label label-primary">ADMIN</span> Me
                  </Link>
                  <Link to="/dashboard/v4" className="image">
          ...
          <div className="col-xl-4 col-lg-6">
            <Panel>
              ...
              <PanelFooter className="text-center">
                <Link to="/dashboard/v4" className="text-inverse">
                  View All
                </Link>
              </PanelFooter>
            </Panel>
